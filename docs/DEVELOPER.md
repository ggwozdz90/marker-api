...
1. Clone the repository:
    ...
    ```bash
    git clone https://github.com/ggwozdz90/marker-api
    cd marker-api
    ```
...
- Build Docker images:
    ...
    ```bash
    docker build -t marker-api:latest .
    ```
...
- [Marker API - Developer Guide](#marker-api---developer-guide)
